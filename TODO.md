...
v3.2
 - Face aware crop (select box with how to do it [center, face to center] underneath the slider)
...
v4.0 - The Appliance
 ...
 - Ships as an image that people can easily flash: pack firmware in deb, check if screen has right firmware, if not warn.
 - OTA update?
