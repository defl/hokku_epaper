...
Portraits (expect at least one face detected):
  ...
  - Violin_player_tuxedo_Getty.jpg  ← multi-face (5 faces in an orchestra)
...
def test_violin_image_detects_multiple_faces(face_detector):
    """Violin_player_tuxedo_Getty.jpg contains several musicians in the background.
    YuNet should return more than one face bbox, exercising the multi-face path."""
    path = _IMAGES / "Violin_player_tuxedo_Getty.jpg"
